...
<html>
  <head>
    ...
    <title>VisitadorMedico | www.fup.com</title>
    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>VisitadorMedico</b></span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">Diego Andres Gutierrez Diaz</span>
                </a>
            ...
            <div class="col-md-12">
              <div class="box">
                <div class="box-header with-border">
                  <h3 class="box-title">Sistema Visitas Medicas</h3>
      ...
      <footer class="main-footer">
        ...
        <strong>FUP<a href="www.incanatoit.com"> VMEDIC</a>.</strong> All rights reserved.
      </footer>
